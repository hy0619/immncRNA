    ...
    <div class="site-content__wrapper">
      <div class="site-content">
        <div class="brand-info">
          <h2 class="brand-info__text">LmmRNA</h2>
          <p class="brand-info__intro">LmmRNA is a database for searching Rna and cancer information</p>
        </div>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          userName: [
            { required: true, message: 'username is not empty', trigger: 'blur' }
          ],
          password: [
            { required: true, message: 'password is not empty', trigger: 'blur' }
          ],
          captcha: [
            { required: true, message: 'captcha is not empty', trigger: 'blur' }
          ]
        },
        captchaPath: ''
      }
