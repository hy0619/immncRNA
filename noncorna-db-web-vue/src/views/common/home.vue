        ...
        if (data && data.code === 0) {
          ...
          this.$http({
            ...
            if (data && data.code === 0) {
             ...
             option.series[1].data = data.tissueOriginList
             option.series[2].data = data.cancerTypeList
             option.series[3].data = data.geneTypeList
             option.series[4].data = data.suvivalList
